...
{{--        <link rel="icon" sizes="192x192" type="image/png" href="{{ asset('media/favicons/favicon-192x192.png') }}">--}}
    ...
    <body>
        ...
        -->
        <div id="page-container" class="enable-cookies sidebar-o enable-page-overlay sidebar-dark side-scroll page-header-fixed">
            <!-- Side Overlay-->
...
{{--                        <i class="fa fa-circle-notch text-primary"></i>--}}
                        <img width="20px" src="{{ asset('media/favicons/logo-icon.png') }}"/>
                        <span class="smini-hide">
                            <span class="font-w700 font-size-h5">CEMS</span> <span class="font-w400">1.0</span>
                        </span>
                    </a>
                    <!-- END Logo -->
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-heading">PHARMACY STOCK</li>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown d-inline-block ml-2">
                            <button type="button" class="btn btn-sm btn-dual" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded" src="{{ asset('media/avatars/avatar7.jpg') }}" alt="Header Avatar" style="width: 18px;">
                                <span class="d-none d-sm-inline-block ml-1">Sar Sreytheanine</span>
                                <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="page-header-user-dropdown">
                                <div class="p-3 text-center bg-primary">
                                    <img class="img-avatar img-avatar48 img-avatar-thumb" src="{{ asset('media/avatars/avatar7.jpg') }}" alt="">
                                </div>
                                <div class="p-2">
...
{{--                        </div>--}}
                        <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-left">
                            <a class="font-w600" href="http://calmette.gov.kh" target="_blank">Calmette Hospital</a> &copy; <span data-toggle="year-copy"></span>
                        </div>
                    </div>
                </div>
            </footer>
